...
class BasicVSR(nn.Module):
    ...
    def __init__(
        self, scale_factor=4, mid_channels=64, num_blocks=30, spynet_pretrained=None
    ):
        super().__init__()
        self.scale_factor = scale_factor
        self.mid_channels = mid_channels  # 中间特征通道数
    ...
    def compute_flow(self, lrs):
        ...
        lrs_2 = lrs[:, 1:, :, :, :].reshape(-1, c, h, w)  # n t-1 c h w -> (n t-1) c h w
    ...
    def forward(self, lrs):
        ...
        outputs = []  # 后向对齐特征序列
        feat_prop = lrs.new_zeros(n, self.mid_channels, h, w)  # 传播特征
